        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
              <Link 
                href="/contacts" 
                className="btn-primary text-lg px-8 py-4 group inline-flex items-center justify-center whitespace-nowrap"
              >
              ...
              <Link 
                href="/about" 
                className="btn-secondary text-lg px-8 py-4 group inline-flex items-center justify-center whitespace-nowrap hover:text-gray-900"
              >
                <span className="flex items-center space-x-2">
            ...
            <div className="grid grid-cols-3 gap-6 max-w-md mx-auto lg:mx-0">
              ...
              <div className="text-center card-lying rounded-3xl p-4 hover-lift">
                ...
                <div className="text-sm text-gray-600">Балов за месяц обучения</div>
              </div>
            </div>
          </div>
