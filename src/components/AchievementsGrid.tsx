export default function AchievementsGrid() {
  ...
  return (
    <section className="section-padding bg-gradient-to-b from-white to-yellow-50 relative overflow-hidden">
      ...
      <div className="absolute bottom-20 left-20 text-6xl opacity-10 animate-float-slow">🎖️</div>
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
            {[
              ...
              <div
                ...
                style={{ animationDelay: `${(achievements.length + index) * 0.1}s` }}
              >
          ...
          <div className="mt-12 text-center">
            <div className="bg-gradient-to-r from-blue-50 to-white rounded-[2rem] shadow-xl p-8 max-w-3xl mx-auto hover-lift">
              ...
              <h4 className="text-2xl lg:text-3xl font-black text-gray-900 mb-4">
