export default function StatsComparison() {
  ...
  return (
    <section className="pt-12 md:pt-8 lg:pt-6 pb-4 md:pb-4 lg:pb-6 bg-gradient-to-b from-white via-yellow-100 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 relative z-10">
        <div className="max-w-4xl mx-auto mb-12 md:mb-8">
          <div className="animate-slide-in-left w-full">
            <div className="card-lying rounded-2xl p-4 sm:p-6 md:p-5 relative overflow-hidden hover-lift bg-white">
              <div className="text-center mb-6 md:mb-4">
                <h3 className="text-2xl sm:text-3xl md:text-xl lg:text-2xl font-black mb-2 bg-gradient-to-r from-yellow-500 to-yellow-600 bg-clip-text text-transparent">
                  Сравнение результатов
                </h3>
                <p className="text-sm sm:text-base md:text-sm text-gray-600">Наши показатели vs средние по стране</p>
              </div>
              
              <div className="space-y-6 md:space-y-4">
                {stats.map((stat, index) => (
                  <div key={index} className="bg-white rounded-2xl p-4 sm:p-6 md:p-4 hover:shadow-lg transition-all duration-300 hover-lift">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 md:mb-3 gap-3 md:gap-2">
                      <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-2">
                        <div className="text-xl sm:text-2xl md:text-lg">{stat.icon}</div>
                        <span className="text-base sm:text-lg md:text-sm font-bold text-gray-800">{stat.label}</span>
                      </div>
                      <div className="flex items-center justify-end space-x-2 sm:space-x-3 md:space-x-2 w-full sm:w-auto">
                        <div className="text-center">
                          <div className="text-xl sm:text-2xl md:text-lg font-black text-yellow-600">
                        ...
                        <div className="text-gray-300 text-xl sm:text-2xl md:text-lg">|</div>
                        <div className="text-center">
                          <div className="text-lg sm:text-xl md:text-base font-bold text-gray-600">
