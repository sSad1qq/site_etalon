...
export const metadata: Metadata = {
  ...
  description: 'Положение об обработке персональных данных Центра подготовки к ЕГЭ и ОГЭ Эталон',
}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-12 md:py-16">
        <div className="bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 shadow-lg">
          ...
          <div className="prose prose-sm sm:prose-base max-w-none text-gray-700 leading-relaxed">
            <p className="mb-4">
              Здесь будет размещено положение об обработке персональных данных.
            </p>
            <p className="mb-4">
